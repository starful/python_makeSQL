...
table_def_excel_path = "C:/work/python/excel/dev_master/"
# 読み込みファイル
wb = xlrd.open_workbook(table_def_excel_path + filename + '.xlsx')
# 出力ファイル
path_w = 'C:/work/python/db/DDL/dev_master/' + filename + '.sql'
